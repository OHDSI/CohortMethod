...
ALTER TABLE @database_schema.@table_prefixcm_covariate_balance ALTER COLUMN target_id TYPE BIGINT;
ALTER TABLE @database_schema.@table_prefixcm_covariate_balance ALTER COLUMN comparator_id TYPE BIGINT;
ALTER TABLE @database_schema.@table_prefixcm_covariate_balance ALTER COLUMN outcome_id TYPE BIGINT;

ALTER TABLE @database_schema.@table_prefixcm_diagnostics_summary ALTER COLUMN target_id TYPE BIGINT;
ALTER TABLE @database_schema.@table_prefixcm_diagnostics_summary ALTER COLUMN comparator_id TYPE BIGINT;
ALTER TABLE @database_schema.@table_prefixcm_diagnostics_summary ALTER COLUMN outcome_id TYPE BIGINT;
