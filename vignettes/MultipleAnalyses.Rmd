...
sharedCovariateBalanceArgs <- createComputeCovariateBalanceArgs()
...
cmAnalysis2 <- createCmAnalysis(analysisId = 2,
                                ...
                                computeSharedCovariateBalanceArgs = sharedCovariateBalanceArgs,
                                fitOutcomeModel = TRUE,
                                fitOutcomeModelArgs = fitOutcomeModelArgs1)
...
outcome <- createOutcome(outcomeId = 192671)
