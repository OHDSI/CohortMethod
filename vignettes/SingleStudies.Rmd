...
We can also plot the propensity score distribution. By defeault, the `plotPS()` function shows the preference score, a transformation of the propensity score that adjusts for differences in sizes between the target and comparator:
...
Note that in this case we may want to use a bootrap to compute the confidence interval.
