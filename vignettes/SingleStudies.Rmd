...
SELECT 2, -- Comparator
	...
	person_id
FROM drug_era
WHERE drug_concept_id IN (1112807,1177480); --Aspirin, Ibuprofen	
...
if (file.exists("c:/temp/mdcrCohortData")){
  cohortData <- loadCohortData("c:/temp/mdcrCohortData")
} else {
...
--Todo: replace concept ID with 3 and use CV:
...
--Todo: replace concept ID with 3
```{r tidy=TRUE,eval=TRUE}
