...
We can use the propensity scores to trim, stratify, match, our weigh our population. For example, one could  trim to equipoise, meaning only subjects with a preference score between 0.25 and 0.75 are kept:
...
We could also use inverse probability of treatment weighting (IPTW):
