...
drawAttritionDiagram <- function(outcomeModel,
  ...
  addStep <- function(label, newCounts, data) {
    ...
    data$rightBoxText[length(data$rightBoxText) + 1] <- paste(treatmentLabel,
                                                              ": n = ",
                                                              data$currentCounts[2] - newCounts[2],
                                                              "\n",
                                                              comparatorLabel,
                                                              ": n = ",
                                                              data$currentCounts[1] - newCounts[1],
                                                              sep = "")
  ...
  data <- list(leftBoxText = c(paste("Exposed population:\n",
                                     treatmentLabel,
                                     ": n = ",
                                     counts$exposedCount[2],
                                     "\n",
                                     comparatorLabel,
                                     ": n = ",
                                     counts$exposedCount[1],
                                     sep = "")), rightBoxText = c(""), currentCounts = counts$exposedCount)
