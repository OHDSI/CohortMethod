...
drawAttritionDiagram <- function(object,
  ...
  addStep <- function(data, attrition, row) {
    ...
    data$rightBoxText[length(data$rightBoxText) + 1] <- paste(treatmentLabel,
                                                              ": n = ",
                                                              data$currentTreated - attrition$treatedPersons[row],
                                                              "\n",
                                                              comparatorLabel,
                                                              ": n = ",
  ...
  data <- list(leftBoxText = c(paste("Original cohorts:\n",
                                     treatmentLabel,
                                     ": n = ",
                                     attrition$treatedPersons[1],
                                     "\n",
                                     comparatorLabel,
                                     ": n = ",
                                     attrition$comparatorPersons[1],
                                     sep = "")), rightBoxText = c(""), currentTreated = attrition$treatedPersons[1], currentComparator = attrition$comparatorPersons[1])
