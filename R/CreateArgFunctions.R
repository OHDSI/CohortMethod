...
#' @param useStratCensorWeights                 for stratified population, use censored weights during model fitting?
...
createFitOutcomeModelArgs <- function(modelType = "logistic",
                                      ...
                                      control = createControl(cvType = "auto",
                                                              ...
                                                              cvRepetitions = 10,
                                                              noiseLevel = "quiet")) {
  if (modelType == "fgr" && is.null(riskId)) {
    warning("No competing risk cohort ID provided for a Fine-Gray model specification")
  }
