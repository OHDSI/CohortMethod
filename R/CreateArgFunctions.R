...
#'
#' @export
createCreatePsArgs <- function(excludePriorOutcome = TRUE,
...
#' Create an object defining the parameter values.
#'
#' @param excludePriorOutcome    Remove people that have the outcome prior to the risk window start
#'                               date?
...
#'
#' @export
createFitOutcomeModelArgs <- function(excludePriorOutcome = TRUE,
                                      stratifiedCox = TRUE,
                                      riskWindowStart = 0,
                                      riskWindowEnd = 9999,
